classdef Gui < vt.Root
	...
	methods
		...
		function gui = createInterface(this)
			...
			%%% End grid way of doing things
			
			
			
			
			
% 			%%% Non-grid way of doing things
...
% 			% + Add a delete region button
		...
		function gui = addRegionSettingsGrid(this, gui)
			...
			% 6-2 + Empty area (for spacing purposes)
			gui.Empty3 = vt.Component.Layout.Empty( ...
				gui.RightBoxGrid ...
			);
			% 7-2 + Save button
			gui.RegionSaveButton = vt.Component.Button.Save( ...
				gui.RightBoxGrid, ...
				'Save' ...
			);
			% 8-2 + Delete button
			gui.RegionSaveButton = vt.Component.Button.DeleteRegion( ...
				gui.RightBoxGrid, ...
				'Delete' ...
			);
			% 9-2 + Cancel button
			gui.RegionCancelButton = vt.Component.Button.Cancel( ...
				gui.RightBoxGrid, ...
				'Cancel' ...
			);
